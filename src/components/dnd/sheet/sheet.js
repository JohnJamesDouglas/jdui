...
import { faSkull, faHeart, faDownload, faUpload, faTrashAlt } from '@fortawesome/free-solid-svg-icons'
import { faCircle, faClock } from '@fortawesome/free-regular-svg-icons'

library.add(faSkull, faHeart, faDownload, faUpload, faTrashAlt, faCircle, faClock)
